...
# $latest_version
xraycore_link="https://github.com/XTLS/Xray-core/releases/download/v1.8.23/xray-linux-64.zip"
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/aixxy7/SSH-XRAY/main/data/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/aixxy7/SSH-XRAY/main/data/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/aixxy7/SSH-XRAY/main/data/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1

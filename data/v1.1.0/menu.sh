...
sleep 2
wget -q -O /root/update.sh "https://raw.githubusercontent.com/aixxy7/SSH-XRAY/main/data/update.sh" && chmod +x /root/update.sh
sleep 2
/root/./update.sh
rm /root/update.sh
#rm /opt/.ver
...
serverV=$( curl -sS https://raw.githubusercontent.com/aixxy7/SSH-XRAY/main/data/version); ##### USING EXTERNAL LINK #####
...
echo -e "$COLOR1 $NC ${WH}Client Name ${COLOR1}: ${WH}https://t.me/aixxy7/ 🇮🇩${NC}"
